/*****************************************************
 * Definitions for DVR-633H recorder for pioneer_rec *
 *****************************************************/

#define RECORDER		"DVR-633H"
#define FNTENTRY_MAGIC	0x0CCC2400	// Entries in FNTENTRY list seem to have this magic

#define FNT_OFFSET	BLOCK_SIZE+32+(3*sizeof(ADDRESS))	// Pointer to FNT directory should be at this offset (sector 5)
